...
<form action ="proc_shop.php" method="post">
<input type="checkbox" value="Nokia 1208 Rp.350.000,-" name="produk1" >Nokia 1208 Rp.350.000,- <br>
...
Member      : <input type=radio name="member" value=Ya checked>Member
